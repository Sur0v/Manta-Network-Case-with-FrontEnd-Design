Made minor changes on the python code to demonstrate the program in a browser interface. HTML file is created with TailWind CSS library, which helps to style the elements. 
